import { $, $c, applyRestAttrs, createComponent, createEffect, forwardProps, hydrate, initChild, renderChild } from '@barefootjs/client/runtime'
...
export function initButton(__scope, _p = {}) {
  ...
  if (_s0) applyRestAttrs(_s0, _p, ["className"])
