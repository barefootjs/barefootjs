 ...
 */
export type TargetedEvent<Target extends EventTarget, E extends Event = Event> = Omit<E, 'target'> & {
...
export type InputEventHandler<T extends EventTarget = HTMLInputElement> = (event: TargetedInputEvent<T>) => void;
export type FocusEventHandler<T extends EventTarget = HTMLElement> = (event: TargetedFocusEvent<T>) => void;
export type KeyboardEventHandler<T extends EventTarget = HTMLElement> = (event: TargetedKeyboardEvent<T>) => void;
export type MouseEventHandler<T extends EventTarget = HTMLElement> = (event: TargetedMouseEvent<T>) => void;
export type ChangeEventHandler<T extends EventTarget = HTMLElement> = (event: TargetedEvent<T>) => void;
...
export type HTMLAttributeFormEnctype = 'application/x-www-form-urlencoded' | 'multipart/form-data' | 'text/plain';
