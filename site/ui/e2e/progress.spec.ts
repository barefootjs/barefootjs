...
test.describe('Progress Reference Page', () => {
  ...
  test.describe('Simulated Upload', () => {
    test('displays preview with progress bar and text', async ({ page }) => {
      const section = page.locator('[bf-s^="ProgressPreviewDemo_"][bf-r]:not([data-slot])').first()
  ...
  test.describe('Basic', () => {
    test('displays basic example', async ({ page }) => {
      ...
      const section = page.locator('[bf-s^="ProgressBasicDemo_"][bf-r]:not([data-slot])').first()
      await expect(section).toBeVisible()
    })
  ...
  test.describe('Form Wizard', () => {
    test('displays form wizard example', async ({ page }) => {
      ...
      const section = page.locator('[bf-s^="ProgressFormDemo_"][bf-r]:not([data-slot])').first()
      await expect(section).toBeVisible()
    })
