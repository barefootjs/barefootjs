...
test.describe('Toggle Reference Page', () => {
  ...
  test.describe('Basic', () => {
    test('displays basic example', async ({ page }) => {
      ...
      const section = page.locator('[bf-s^="ToggleBasicDemo_"][bf-r]:not([data-slot])').first()
  ...
  test.describe('Outline', () => {
    test('displays outline example', async ({ page }) => {
      ...
      const section = page.locator('[bf-s^="ToggleOutlineDemo_"][bf-r]:not([data-slot])').first()
      await expect(section).toBeVisible()
    })
  ...
  test.describe('Toolbar', () => {
    test('displays toolbar example', async ({ page }) => {
      ...
      const section = page.locator('[bf-s^="ToggleToolbarDemo_"][bf-r]:not([data-slot])').first()
      await expect(section).toBeVisible()
    })
